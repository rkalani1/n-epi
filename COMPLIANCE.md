...
Public-use boundary: Public example datasets only. Do not upload patient data, participant identifiers, proprietary cohorts, restricted research data, or confidential material.
