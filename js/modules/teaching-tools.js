...
(function () {
    ...
    var biostatQuizBank = [
        ...
        {
            q: 'Using facility discharge records from 2010-2020, researchers identify patients who had DVT and compare prior oral contraceptive use to matched controls without DVT. What study design is this?',
        ...
        {
            q: 'A facility assigns even-numbered beds to receive a new hand hygiene protocol and odd-numbered beds to standard care. This is best described as:',
        ...
        {
            q: 'A study of facility patients finds a strong association between two diseases that is absent in the general population. This discrepancy is due to:',
            options: ['Confounding', 'Berkson bias', 'Misclassification bias', 'Ecological fallacy'],
            answer: 1,
            explanation: 'Berkson bias (admission rate bias) occurs when facility-based sampling creates a spurious association because the probability of inpatient stay differs by disease status. Both diseases independently increase inpatient stay probability.'
        },
        {
        ...
        {
            q: 'You have count data (number of facility readmissions per patient over 1 year) and want to model predictors of readmission. The best model is:',
    ...
    var flashcardDeck = [
        ...
        { term: 'Selection Bias', definition: 'Systematic error arising from how participants are selected or retained in a study, leading to a non-representative sample.', example: 'Studying only inpatient patients may create Berkson bias if admission rates differ by exposure and disease status.' },
                    ...
                    options: [
                        {
                            ...
                            next: {
                                ...
                                options: [
                                    ...
                                    {
                                        label: 'Groups/clusters (clinics, facilities, communities)',
                                        result: {
                        ...
                        },
                        {
                            ...
                            result: {
                                ...
                                description: 'The investigator assigns the intervention, but without random allocation (e.g., by facility, by time period, by alternation). Includes before-after studies, interrupted time series, and regression discontinuity designs.',
                                ...
                                examples: 'Interrupted time series of a facility stroke protocol change; before-after studies of clinical pathways'
                            }
                        }
                    ]
                }
    ...
    var glossaryTerms = [
        ...
        { term: 'Confidence Interval', def: 'A range computed by a procedure that captures the true population parameter in a stated proportion of repeated samples (usually 95%). Not a 95% probability that the parameter lies in this specific interval.' },
        { term: 'Confounding', def: 'Distortion of an exposure-outcome association by a third variable that is associated with both the exposure and the outcome and is not on the causal pathway between them.' },
