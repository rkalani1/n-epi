...
(function() {
    ...
    checklists['PRISMA'] = [
        ...
        { num: '13a', section: 'Methods', text: 'Describe the processes used to decide which studies were eligible for each synthesis (e.g., tabulating the study intervention characteristics and comparing against the planned groups for each synthesis)' },
        { num: '13b', section: 'Methods', text: 'Describe any methods required to prepare the data for presentation or synthesis, such as handling of missing summary statistics or data conversions' },
        { num: '13c', section: 'Methods', text: 'Describe any methods used to tabulate or visually display results of individual studies and syntheses' },
        { num: '13d', section: 'Methods', text: 'Describe any methods used to synthesize results and provide a rationale for the choice(s). If meta-analysis was performed, describe the model(s), method(s) to identify the presence and extent of statistical heterogeneity, and software package(s) used' },
        { num: '13e', section: 'Methods', text: 'Describe any methods used to explore possible causes of heterogeneity among study results (e.g., subgroup analysis, meta-regression)' },
        { num: '13f', section: 'Methods', text: 'Describe any sensitivity analyses conducted to assess robustness of the synthesized results' },
        ...
        { num: '16a', section: 'Results', text: 'Describe the results of the search and selection process, from the number of records identified in the search to the number of studies included in the review, ideally using a flow diagram' },
        { num: '16b', section: 'Results', text: 'Cite studies that might appear to meet the inclusion criteria, but which were excluded, and explain why they were excluded' },
        ...
        { num: '19', section: 'Results', text: 'For all outcomes, present for each study: (a) summary statistics for each group (where appropriate) and (b) an effect estimate and its precision (e.g., confidence/credible interval)' },
        { num: '20a', section: 'Results', text: 'For each synthesis, briefly summarise the characteristics and risk of bias among contributing studies' },
        { num: '20b', section: 'Results', text: 'Present results of all statistical syntheses conducted. If meta-analysis was performed, present for each the summary estimate and its precision (e.g., 95% CI) and measures of statistical heterogeneity. If comparing groups, describe the direction of effect' },
        { num: '20c', section: 'Results', text: 'Present results of all investigations of possible causes of heterogeneity among study results' },
        { num: '20d', section: 'Results', text: 'Present results of all sensitivity analyses conducted to assess the robustness of the synthesized results' },
        ...
        { num: '23d', section: 'Discussion', text: 'Discuss implications of the results for practice, policy, and future research' },
        { num: '24a', section: 'Other Information', text: 'Provide registration information for the review, including register name and registration number, or state that the review was not registered' },
        { num: '24b', section: 'Other Information', text: 'Indicate where the review protocol can be accessed, or state that a protocol was not prepared' },
        { num: '24c', section: 'Other Information', text: 'Describe and explain any amendments to information provided at registration or in the protocol' },
        { num: '25', section: 'Other Information', text: 'Describe sources of financial or non-financial support for the review, and the role of the funders or sponsors in the review' },
    ...
    // CHEERS 2022 (Husereau et al. BMJ 2022;376:e067975) — all 28 items.
    checklists['CHEERS'] = [
        { num: '1',  section: 'Title', text: 'Identify the study as an economic evaluation, or use more specific terms (e.g., "cost-effectiveness analysis"), and describe the interventions compared' },
        { num: '2',  section: 'Abstract', text: 'Provide a structured summary that highlights context, key methods, results, and alternative analyses' },
        { num: '3',  section: 'Introduction', text: 'Give the context for the study, the study question, and its practical relevance for decision making in policy or practice' },
        { num: '4',  section: 'Methods', text: 'Describe characteristics of the population (e.g., age, sex, race/ethnicity, socio-economic, clinical) and any subgroups studied separately' },
        { num: '5',  section: 'Methods', text: 'Describe relevant aspects of the system in which the decision(s) needs to be made' },
        { num: '6',  section: 'Methods', text: 'State the perspective(s) adopted by the study and why chosen' },
        { num: '7',  section: 'Methods', text: 'Describe the interventions or strategies being compared and why chosen' },
        { num: '8',  section: 'Methods', text: 'State the time horizon over which costs and consequences are being evaluated and why appropriate' },
        { num: '9',  section: 'Methods', text: 'Report the discount rate(s) and reason chosen' },
        { num: '10', section: 'Methods', text: 'Describe what outcomes were used as the measure(s) of benefit(s) and harm(s)' },
        { num: '11a', section: 'Methods', text: 'Describe how health outcomes (and their values where applicable, e.g., utilities) were measured for cost-utility or cost-benefit analyses' },
        { num: '11b', section: 'Methods', text: 'Describe the population and methods used to elicit preferences for outcomes' },
        { num: '12', section: 'Methods', text: 'Describe how costs were valued' },
        { num: '13', section: 'Methods', text: 'Report the dates of the estimated resource quantities and unit costs, plus the currency and year of conversion' },
        { num: '14', section: 'Methods', text: 'Describe and give reasons for the specific type of decision-analytic model used. Providing a figure to show model structure is strongly recommended' },
        { num: '15', section: 'Methods', text: 'Describe and give reasons for any assumptions used in the analysis' },
        { num: '16', section: 'Methods', text: 'Describe any methods for analysing or statistically transforming data, any extrapolation methods, and approaches to validate the model used' },
        { num: '17', section: 'Methods', text: 'Describe any approaches to characterise heterogeneity, e.g., subgroup analyses' },
        { num: '18', section: 'Methods', text: 'Describe any approaches used to characterise distributional effects (i.e., how impacts are distributed across populations)' },
        { num: '19', section: 'Methods', text: 'Describe any approaches to characterise uncertainty (e.g., probabilistic / deterministic sensitivity analyses, scenarios, value-of-information)' },
        { num: '20', section: 'Methods', text: 'Describe any approaches to engagement with patients or service recipients, the public, communities, or stakeholders (e.g., to inform model development)' },
        { num: '21', section: 'Results', text: 'Report all analytic inputs (e.g., values, ranges, references) including uncertainty or distributional assumptions' },
        { num: '22', section: 'Results', text: 'Report the means as well as appropriate measures of uncertainty for the main categories of costs and outcomes of interest, and summarise them' },
        { num: '23', section: 'Results', text: 'Describe how the results of the analysis address heterogeneity' },
        { num: '24', section: 'Results', text: 'Describe how the results of the analysis address distributional effects' },
        { num: '25', section: 'Results', text: 'Describe how the results of the analysis characterise uncertainty' },
        { num: '26', section: 'Discussion', text: 'Report the findings, limitations, generalisability, and implications for practice' },
        { num: '27', section: 'Other', text: 'Describe how the study was funded and any role of the funder in identification, design, conduct, and reporting of the analysis' },
        { num: '28', section: 'Other', text: 'Report any conflicts of interest among study contributors in accordance with journal policy. In the absence of a journal policy, ICMJE recommendations are encouraged' }
    ];
