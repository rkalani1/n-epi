...
(function() {
    ...
    function buildClusterTab() {
        ...
        html += '<div class="form-label">Common Presets</div>';
        html += '<div class="preset-group">'
            + '<button class="preset-btn" onclick="SampleSizeModule.loadClusterPreset(\'facility\')">Facility Clusters (N=500, ICC=0.03, m=30)</button>'
    ...
    function loadClusterPreset(name) {
        var presets = {
            facility: { n: 500, icc: 0.03, size: 30 },
