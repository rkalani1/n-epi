...
(function() {
    ...
    function renderTestSelectorCard() {
    ...
    function renderDistributionsCard() {
        var html = '<div class="card">';
    ...
    function renderEffectSizesCard() {
        var html = '<div class="card">';
    ...
    function renderMultipleTestingCard() {
        var html = '<div class="card">';
    ...
    function render(container) {
        ...
        html += renderTestSelectorCard();
        html += renderDistributionsCard();
        html += renderCLTDemonstrator();
        html += renderHypothesisFlowchart();
        html += renderCIMethodsCard();
        html += renderEffectSizesCard();
        html += renderMultipleTestingCard();
